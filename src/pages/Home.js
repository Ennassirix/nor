...
import {ReactComponent as Iptv} from '../icons/iptv.svg';
import {ReactComponent as ShahidVip} from '../icons/shahidvip.svg';
    ...
    return(
        <>
            ...
            <div className='why-section'>
                ...
                <div className='why-icon-desc'>
                    <div className='why-icon'>
                        <WhyIcon width='512px' height='512px'/>
                    </div>
            ...
            <div className='category-section'>
                ...
                <div className='giftcards-category'>
                    <h2>Gift Cards</h2>
                    <div className='gc-products'>

                    </div>
                </div>
                <div className='serialkeys-category'>
                    <h2>Serial Keys</h2>
